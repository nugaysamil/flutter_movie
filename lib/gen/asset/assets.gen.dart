...
class $AssetsLottieGen {
  ...
  /// File path: assets/lottie/Polite Chicky.json
  LottieGenImage get politeChicky =>
      const LottieGenImage('assets/lottie/Polite Chicky.json');

  /// List of all assets
  List<LottieGenImage> get values => [politeChicky];
}
