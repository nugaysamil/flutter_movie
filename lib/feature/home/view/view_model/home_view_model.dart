// ignore_for_file: public_member_api_docs, constant_identifier_names, inference_failure_on_function_invocation, unused_local_variable, avoid_dynamic_calls, deprecated_member_use, type_annotate_public_apis, avoid_print
...
abstract class HomeViewModel extends State<MovieResults> {
  ...
  Future<void> fetchAllData() async {
    try {
      final response = await dio.get(
        ServicePath.POPULAR_MOVIES.rawValue,
        queryParameters: {
